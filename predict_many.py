...
def run_many(fasta_files: list, predictions_dir: Path, single_chain: bool = True, decoys: int = 5, num_procs: int = 12, skip_if_exist: bool = True, renumber: bool = True):
    device_type = 'cuda'
...
def cli():
    ...
    if single_chain:
        print("We are considering only one chain!")
